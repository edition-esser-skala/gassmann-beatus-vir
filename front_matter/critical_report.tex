...
\lastname{Gassmann}
\title{Beatus vir qui inventus est sine macula}
\shorttitle{Beatus vir}
\subtitle{Offertorium de Ascensione Domini et de Quocunque Sancto Martyre\\(A-Ed B 82)}
\scoring{B (solo), S, A, T, B (coro), 2 clno, timp, 2 vl, vla, b, org}
\maketitle
...
This edition bases upon a copy in the Dommusikarchiv Eisenstadt. The digital version of the manuscript is available at \url{http://dommusikarchiv.martinus.at/site/werkverzeichnis/gallery/869.html} (siglum B 82; see also RISM ID 600038048).
...
\begin{longtable}{ll L{10cm}}
  ...
  \midrule \endhead
  –   & org     & In the Ms, bass figures only appear in bars 9 to 11 and 146 to 198. The remaining bass figures were added by the editor. \\
  18  & timp    & 1st quarter in Ms: G4 \\
  19  & vla     & 2nd half of bar in Ms: fis′4.–fis′8 \\
  24  & timp    & bar missing in Ms \\
  25  & timp    & 2nd quarter in Ms: G8–G8 \\
  26  & clno 1  & bar missing in Ms \\
  28  & clno 2  & 2nd quarter in Ms: g′8–g′8 \\
  52  & vl 2    & grace note missing in Ms \\
  62  & vl 2    & grace note missing in Ms \\
  94  & clno 2  & 2nd quarter in Ms: c′8.–g16 \\
  111 & vl 1    & grace note missing in Ms \\
  115 & vl 1    & grace note missing in Ms \\
  129 & timp    & 3rd quarter in Ms: r4 \\
  145 & clno 1  & bar in Ms: g″4–g″2 \\
  152 & vl 2    & grace note missing in Ms \\
  173 & vl 1, 2 & grace note missing in Ms \\
  160 & S       & bar in Ms: d″2–r4 \\
  187 & vl 2    & 2rd quarter in Ms: b′16–b′16–g″16–g″16 \\
  198 & timp    & bar in Ms: G4–r4–r4 \\
  198 & vla     & bar in Ms: g′4–r4–r4 \\
  198 & org     & bar in Ms: g4–r4–r4 \\
  198 & –       & In clno 1, 2, timp, S, A, and T, 17 measures in e minor follow; however, these measures are missing in all other parts and thus were omitted in this edition. \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/gassmann-beatus-vir}. Your help will be greatly appreciated.
...
nec speravit in pecuniae thesauri.

Age pugnam appara
gens tot palmis tumida
hunc si potes vincito.
Terga vertis pavida
et lauros ante proelia
cedis magna animo.
